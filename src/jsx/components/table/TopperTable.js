...
const TopperTable = () => {
   const [data, setData] = useState(
      document.querySelectorAll("#TopperTable_basic_table tbody tr")
   );
   const sort = 5;
   ...
   // use effect
   useEffect(() => {
      setData(document.querySelectorAll("#TopperTable_basic_table tbody tr"));
      chackboxFun();
   }, [test]);
      ...
      <div className="col-12">
         <div className="card">
            <div className="card-header">
               <h4 className="card-title">Exam Topper Table</h4>
            </div>
            <div className="card-body">
               <Table responsive className="w-100">
                  <div
                     id="TopperTable_basic_table"
