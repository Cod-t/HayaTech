          ...
          <div className={`sidebar-right ${settingToggle ? "show" : ""}`}>
            ...
            <div className="sidebar-right-inner">
              ...
              <div className="note-text">
                <span className="text-danger">*Note :</span> This theme switcher is not part of product. It is only for demo. you will get all guideline in documentation. please check <a href="https://mediqu.dexignzone.com/react/doc" target="_blank" className="text-primary">documentation.</a>
              </div>				
            </div>
         </div>
                ...
                <div className="bg-close"  onClick={() => setDemoToggle(!demoToggle)} ></div>
                  ...
                  <div className="dz-demo-inner">
                    <div className="dz-demo-header">
                      <h3 className="text-white">Select  Demo</h3> 
                  ...
                  <div className="dz-demo-content">
                    ...
                    <div className="note-text">
                     <span className="text-danger">*Note :</span>
                      ...
                      <Link to={"https://mediqu.dexignzone.com/react/doc"}  rel="noreferrer"  target='_blank' className="text-white"> documentation.</Link>
                    </div>
                </div>
              </div>
    </>
